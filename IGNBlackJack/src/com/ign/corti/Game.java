...
public class Game extends JFrame implements ActionListener {
    ...
    private void hitMe() {
        ...
        lblScore.setText("Playr Score: " + player.value());
        playerPanel.updateUI();
    }
    /**
    ...
    /**
     * this will have the dealer get one card face down
     */
    ...
    private void checkWinner() {
        ...
        //depending on the scenario the lable will change 
        if (player.value() > 21) {
    ...
    /**
     * this will allow the btns to activate 
     */
